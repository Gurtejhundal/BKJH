...
class GalleryCategoryAdmin(admin.ModelAdmin):
    list_display = ("name", "hospital_scope", "is_active", "display_order")
    ...
    fieldsets = (
        ("Gallery category", {"description": "Use categories to keep real hospital photos organized.", "fields": ("name", "hospital_scope", "description")}),
...
class GalleryImageAdmin(admin.ModelAdmin):
    list_display = ("title", "hospital_scope", "category", "is_featured", "is_active", "display_order", "created_at")
    list_display_links = ("title",)
    list_editable = ("is_featured", "is_active", "display_order")
    list_filter = ("hospital_scope", "category", "is_featured", "is_active")
    ...
    fieldsets = (
        ("Image details", {"description": "Upload approved real hospital photos. Alt text should describe the image for patients using screen readers.", "fields": ("hospital_scope", "category", "title", "image", "alt_text", "caption")}),
        ("Built-in deployed image", {"classes": ("collapse",), "description": "Used for approved photos committed with the website. Leave empty for normal admin uploads.", "fields": ("static_image_path",)}),
